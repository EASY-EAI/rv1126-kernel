...
#define QUECTEL_PRODUCT_EC200T0			0x6000
#define QUECTEL_PRODUCT_EC200T1			0x6026
...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE(QUECTEL_VENDOR_ID, QUECTEL_PRODUCT_EC200T0),
	  .driver_info = RSVD(0) },
	{ USB_DEVICE(QUECTEL_VENDOR_ID, QUECTEL_PRODUCT_EC200T1),
	  .driver_info = RSVD(0) },
...
static struct usb_serial_driver option_1port_device = {
	...
	.reset_resume      = usb_wwan_resume, //add by bkq
